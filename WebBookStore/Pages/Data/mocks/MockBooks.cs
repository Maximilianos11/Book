...
{
	public class MockBooks : IAllBookDesc
	{
		public IEnumerable<BookDescr> BookDescr
		{
			get
			{
				return new List<BookDescr>
				{
					new BookDescr {img="https://static.librebook.me/uploads/pics/02/26/209.jpg",
						name= "Старик и море",
					...
					" к морю зацепит каждого поклонника творчества Хемингуэя",
						...
						available=true},
					new BookDescr {img="https://img.yakaboo.ua/media/catalog/product/cache/1/image/546x/00c1a1eab9920e00d38dc8798e6142c9/4/0/407484_61809030.jpg",
					...
					" В этом создании наш поэт почти в первый раз заговорил языком развязным, свободным, текучим, звонким, гармоническим...",
						available=true},
					new BookDescr {img="https://i3.mybook.io/p/512x852/book_covers/a4/72/a4721d84-6323-4f79-90e4-391f7afd41fa.jpe?v2",
		...
		public BookDescr getObjectBook(int BookId)
		{
